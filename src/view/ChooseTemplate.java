...
public class ChooseTemplate {
	...
	private void initialize() {
		...
		book.addActionListener(e -> diselectRadioButtons(book, article, report, letter));
		...
		article.addActionListener(e -> diselectRadioButtons(article, book, report, letter));
		article.setBounds(42, 137, 127, 25);
		frame.getContentPane().add(article);
		
		
		report.addActionListener(e -> diselectRadioButtons(report, article, book, letter));
		report.setBounds(213, 51, 127, 25);
		frame.getContentPane().add(report);
		
		
		letter.addActionListener(e -> diselectRadioButtons( letter, report, article, book));
