...
public class MainWindow {
	...
	public void editContents(String type) {
		...
		switch (type) {
			case "chapter" -> contents = before + "\n\\chapter{...}" + "\n" + after;
			case "section" -> contents = before + "\n\\section{...}" + "\n" + after;
			case "subsection" -> contents = before + "\n\\subsection{...}" + "\n" + after;
			case "subsubsection" -> contents = before + "\n\\subsubsection{...}" + "\n" + after;
			case "enumerate" -> contents = before +
					"\\begin{enumerate}\n" +
					"\\item ...\n" +
					"\\item ...\n" +
					"\\end{enumerate}\n" + after;
			case "itemize" -> contents = before +
					"\\begin{itemize}\n" +
					"\\item ...\n" +
					"\\item ...\n" +
					"\\end{itemize}\n" + after;
			case "table" -> contents = before +
					"\\begin{table}\n" +
					"\\caption{....}\\label{...}\n" +
					"\\begin{tabular}{|c|c|c|}\n" +
					"\\hline\n" +
	...
	private void initialize() {
		...
		mntmNewFile.addActionListener(arg0 -> {
